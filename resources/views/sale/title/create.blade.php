...
<script>
    ...
    @if(Session::has('error'))
        <div class="flex bg-red-300 rounded-lg p-4 mb-4 text-sm text-red-900" role="alert">
            ...
            <div>
                <span class="font-medium">{{ __('translation.error') }} !</span> {{ __('translation.about_field') }}
            </div>
        </div>
    @endif
   @if ($errors->any())
        ...
        <div class="bg-white w-full shadow rounded p-8 sm:p-12 -mt-96">
            <form method="POST" action="{{ route('titles.store') }}">
                ...
                <div class="mt-10">
                    ...
                    <input class="w-full mt-2 py-3 px-4 bg-gray-100 text-gray-700 border border-gray-300 rounded  block appearance-none placeholder-gray-500 focus:outline-none focus:bg-white" name="name_ar" type="name" />
                </div>
                ...
                <div class="mt-5" id="text_en" style="display: none;">
                    ...
                    <input class="w-full mt-2 py-3 px-4 bg-gray-100 text-gray-700 border border-gray-300 rounded  block appearance-none placeholder-gray-500 focus:outline-none focus:bg-white" name="name_en" type="name" />
                </div>
                ...
                <div class="mt-10">
                    ...
                    <input type="color" class="w-full mt-2 px-4 bg-gray-100 text-gray-700 border border-gray-300 rounded  block appearance-none placeholder-gray-500 focus:outline-none focus:bg-white" name="text_color" />
                </div>
                ...
                <div class="mt-10">
                    ...
                    <input type="color" class="w-full mt-2 px-4 bg-gray-100 text-gray-700 border border-gray-300 rounded  block appearance-none placeholder-gray-500 focus:outline-none focus:bg-white" name="bg_color" />
                </div>
